...
module('learnG').controller('surveyController', function($scope, $routeParams, $http) {
	...
	var surveyType = $routeParams.surveyId
		...
		game.state.start('PracticeState');
